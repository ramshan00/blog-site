...
const BooksPage = () => {
  return (
    <div className="p-8 max-w-6xl mx-auto  pb-20">
      <h1 className="  mt-28 text-4xl font-bold mb-6 flex text-right py-7 gap-2 cursor-pointer hover:text-[#f38b8b]">
        Explore Recent Blog
      </h1>
      ...
      <div className="grid grid-cols-1 gap-8">
        {latest.map((last) => (
          <div
            key={last.id}
            className="flex items-center border rounded shadow-md hover:shadow-xl transition-all overflow-hidden"
          >
            <Image
              src={last.image}
              alt={last.title}
